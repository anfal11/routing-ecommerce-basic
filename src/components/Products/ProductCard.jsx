...
const ProductCard = ({ product }) => {
  const {id, price, images, title, rating } = product;

  return (
    <div className="flex">

      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-xl shadow-slate-400">

        <img className="p-8 rounded-t-lg object-contain w-full h-96" src={images[0]} alt="product image"/>
